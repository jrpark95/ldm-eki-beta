...
// Log file handle (required for non-RDC link compatibility)
// In standalone mode, this remains nullptr (no detailed logging)
 ...
 *
 * @note Uses single-process mode (PROCESS_INDEX = 0)
...
int main(int argc, char** argv) {
    ...
    std::string nuclide_config_file = "./input/ldm/nuclides_config_1.txt";
